...
class LagSwitchApp:
    ...
    def setup_ui(self):
        self.status_label = ctk.CTkLabel(self.root, text="LagSwitch off.", text_color="red")
        ...
        self.keybind_label.grid(row=1, column=0, padx=10, pady=5)
