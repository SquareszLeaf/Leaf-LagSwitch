...
print("im suppose to be here dont worry")
...
root = tk.Tk()
root.title("Leaf Lag Switch V2.2")

status_label = tk.Label(text="*turn off lag switch before closing")
...
root.geometry("325x230")  # Set initial width and height of the GUI
