...
class LagSwitchApp:
    ...
    def setup_ui(self):
        ...
        ctk.CTkLabel(self.root, text="Leaf Lag V2.2.8").grid(row=0, column=1, padx=0, pady=0)
    ...
    def set_keybind(self, event):
        ...
        keyboard.on_release_key(self.settings["Keybind"], self.toggle_block_off)
    ...
    def toggle_block_off(self, event):
        if self.block_flag:
